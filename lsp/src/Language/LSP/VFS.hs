...
virtualFileGhostLanguageKind :: VirtualFileGhost -> Maybe J.LanguageKind
virtualFileGhostLanguageKind vf = _ghost_language_id vf
...
virtualFileEntryLanguageKind (Closed vf) = virtualFileGhostLanguageKind vf
