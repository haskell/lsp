...
data CompletionItem = CompletionItem 
  ...
  @since 3.17.0
  -}
  labelDetails :: (Maybe Language.LSP.Protocol.Internal.Types.CompletionItemLabelDetails.CompletionItemLabelDetails)
  , {-|
  The kind of this completion item. Based of the kind
  an icon is chosen by the editor.
  -}
  kind :: (Maybe Language.LSP.Protocol.Internal.Types.CompletionItemKind.CompletionItemKind)
  , {-|
  Tags for this completion item.

  @since 3.15.0
  -}
  tags :: (Maybe [Language.LSP.Protocol.Internal.Types.CompletionItemTag.CompletionItemTag])
  , {-|
  ...
  *Note* that only one completion item can be selected and that the
  ...
  side interpretation.
  -}
  insertText :: (Maybe Data.Text.Text)
  , {-|
  ...
  *Note 2:* If an `InsertReplaceEdit` is returned the edit's insert range
  ...
  -}
  textEdit :: (Maybe (Language.LSP.Protocol.Internal.Types.TextEdit.TextEdit Language.LSP.Protocol.Types.Common.|? Language.LSP.Protocol.Internal.Types.InsertReplaceEdit.InsertReplaceEdit))
  , {-|
  ...
  @since 3.17.0
  -}
  textEditText :: (Maybe Data.Text.Text)
  , {-|
